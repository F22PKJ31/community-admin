	...
	<div class="table">
		...
		<div class="container">
			<div class="handle-box">
				...
				<el-button @click="addNews" style="float: right;" type="primary">撰写新闻</el-button>
			</div>
...
<script>
    export default {
        ...
        methods: {
            ...
            addNews() {
                this.$router.push({name: 'editNewsPage', query: {}})
            ...
            handleDetail(index, row) {
                this.idx = index;
                this.$router.push({name: 'newsDetail', query: {'newsId': this.tableData[this.idx].newsId}})
            },
            handleEdit(index, row) {
                this.idx = index;
                this.$router.push({name: 'editNewsPage', query: {'newsId': this.tableData[this.idx].newsId}})
            },
            noPassRow() {
                this.approval(-1);
